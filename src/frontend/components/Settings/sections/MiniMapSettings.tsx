...
export const MiniMapSettings = () => {
  ...
  return (
    <BaseSettingsSection
      title="Mini Map"
      description="Configure mini map visualization settings."
      settings={settings}
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xs text-slate-400">
                Show turn numbers and names on the mini map
              </p>
            </div>
            <ToggleSwitch
          ...
          <div className="space-y-2">
            ...
            <p className="text-slate-400 text-sm">
              Size of the circle for other drivers on the mini map
            </p>
          </div>
          ...
          <div className="space-y-2">
            ...
            />
            <p className="text-slate-400 text-sm">
              Size of the circle for the player on the mini map
            </p>
          </div>
          ...
          <div className="space-y-2">
            ...
            />
            <p className="text-slate-400 text-sm">
              Width of the mini map track outline
            </p>
          </div>
